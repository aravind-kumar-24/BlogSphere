    ...
    <head>
        ...
        <style>
            * {
            ...
            .blogger-email-verify {
                text-align: center;
            }

            .blogger-email-verify p {
                color: #4A4A4A;
                font-size: 18px;
                line-height: 1.6;
                margin-bottom: 30px;
            ...
            .verify-email-button {
                ...
                background: linear-gradient(135deg, #C97C5D, #D88A6A);
        ...
        <div class="registration-completed-email-container">
            <div class="registration-completed-mail">
                ...
                <p class="welcome-message">
                    Your registration is successfully completed. Welcome to <span>BlogSphere</span>.
                </p>
                <div class="blogger-email-verify">
                    <p>
                        To complete your registration, please verify your email by clicking the button below:
                    </p>
                    <div>
                        <a href="{{ $verification_url }}" class="verify-email-button">
                            Verify Email
                        </a>
                    </div>  
                </div>
