$(document).ready(function(){
    ...
    $('#old_password, #new_password, #confirm_new_password').on('input', function(){
        let password = input_value_restrictions($(this).val(), 'password');
        $(this).val(password);
    })

    $('.old-password-eye-open').on('click', function(){
        let password_type = $('#old_password').attr('type')
    ...
    $('.new-password-eye-open').on('click', function(){
        let password_type = $('#new_password').attr('type')
    ...
    $('.confirm-new-password-eye-open').on('click', function(){
        let password_type = $('#confirm_new_password').attr('type')
