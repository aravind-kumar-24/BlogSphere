            ...
            <div class="top-section">
                <div class="top-section-01">
                    <div>
                        ...
                        <input type="text" id="first_name" name="first_name" placeholder="First Name" value="{{old('first_name')}}" autocomplete="off"/>
                        <small class="error"></small>
                    </div>
                    <div>
                        <label for="last_name">Last Name</label>
                        <input type="text" id="last_name" name="last_name" placeholder="Last Name" value="{{old('last_name')}}" autocomplete="off"/>
                        <small class="error"></small>
                    </div>
                </div>
                <div class="top-section-02">
                    <div>
                        ...
                        <input type="text" id="user_name" name="user_name" placeholder="User Name" value="{{old('user_name')}}" autocomplete="off"/>
                        <small class="error"></small>
                    </div>
                    <div>
                        <label for="profession">Profession</label>
                        <input type="text" name="profession" id="profession" placeholder="Profession" value="{{old('profession')}}" autocomplete="off"/>
                        <small class="error"></small>
                    </div>
                </div>
                <div class="top-section-03">
                    ...
                    <div>
                        ...
                        <input maxlength="10" type="text" id="contact_number" name="contact_number" placeholder="Contact Number" value="{{old('contact_number')}}" autocomplete="off"/>
                        <small class="error"></small>
                    </div>
                </div>
                ...
                <div class="top-section-08">
                    ...
                    <div class="confirm_password_field">
                        ...
                        <div class="confirm_password_input">
                            <input maxlength="15" type="password" name="password_confirmation" id="confirm_password" placeholder="Confirm Password"/>
                    ...
                    error: function(error){
                        ...
                        if(error.status === 422){
                            ...
                            for (let field in errors) {
                                ...
                                } else if(field === 'terms_and_conditions') {
                                    $field.closest('div').find('.error').text(errors[field][0]);
                                } else if(field === 'password' || field === 'password_confirmation') {
                                    $field.closest('.password_field, .confirm_password_field').find('.error').text(errors[field][0]);
                                } else {
